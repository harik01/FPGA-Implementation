...
HD_PWD='C:/Users/ADMIN/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vedic_4.tcl -notrace
