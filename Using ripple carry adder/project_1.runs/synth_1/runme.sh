...
HD_PWD='C:/Users/ADMIN/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vedic_4.tcl
