...
HD_PWD='C:/Users/ADMIN/Vedic 4 x4 using CLA/Vedic 4 x4 using CLA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic_4cla.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vedic_4cla.tcl -notrace
