...
HD_PWD='C:/Users/ADMIN/Vedic 4 x4 using CLA/Vedic 4 x4 using CLA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic_4cla.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vedic_4cla.tcl
