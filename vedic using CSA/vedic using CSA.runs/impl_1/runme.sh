...
HD_PWD='C:/Users/ADMIN/vedic using CSA/vedic using CSA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic_4CSA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vedic_4CSA.tcl -notrace
