...
set rc [catch {
  ...
  open_checkpoint vedic_4CSA_routed.dcp
  set_property webtalk.parent_dir {C:/Users/ADMIN/vedic using CSA/vedic using CSA.cache/wt} [current_project]
  catch { write_mem_info -force vedic_4CSA.mmi }
  write_bitstream -force vedic_4CSA.bit 
  catch {write_debug_probes -quiet -force vedic_4CSA}
  catch {file copy -force vedic_4CSA.ltx debug_nets.ltx}
