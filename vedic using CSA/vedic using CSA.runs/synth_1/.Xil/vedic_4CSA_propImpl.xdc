set_property SRC_FILE_INFO {cfile:{C:/Users/ADMIN/vedic using CSA/vedic using CSA.srcs/constrs_1/new/vediccsa.xdc} rfile:{../../../vedic using CSA.srcs/constrs_1/new/vediccsa.xdc} id:1} [current_design]
