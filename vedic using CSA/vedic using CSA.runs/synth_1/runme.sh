...
HD_PWD='C:/Users/ADMIN/vedic using CSA/vedic using CSA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic_4CSA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vedic_4CSA.tcl
